  ...
  return (
    <div className="flex justify-center items-center min-h-screen mb-9">
      ...
      <a className=" w-full flex item-center justify-center xl:mr-8 mb-2" href="home">
        ...
        <div>
          <button class="flex mb-2 items-center justify-center py-2 px-20 bg-white hover:  text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg hover:scale-105">
            <svg
              viewBox="0 0 24 24"
              height="25"
              width="25"
