  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen mb-9 mt-14 md:mt-3">
      ...
      <a className=" w-full flex item-center justify-center xl:mr-8 mb-2" href="home">
        ...
        <h2 className="text-2xl text-center font-bold text-gray-900 ">Sign Up</h2>
        <p className='text-lg text-gray-500 text-center mb-6'>Create your account</p>
        <form action="#">
          {/* First Name Field */}
          <div className="w-full h-12 relative flex rounded-xl mb-4">
            <input
              required
              className="peer w-full  outline-none px-4 text-base rounded-xl bg-white  border-2 hover:border-n-8 shadow-md focus:shadow-md focus:shadow-n-8 "
              id="first-name"
              type="text"
              placeholder=" "
            />
            <label
              className="absolute text-gray-800 top-1/2 -translate-y-1/2 bg-transparent left-4 px-2 peer-focus:top-0 peer-focus:left-3 peer-focus:text-md peer-focus:text-n-9 peer-valid:top-0 peer-valid:left-3 peer-valid:text-md peer-valid:text-n-9 duration-150"
              htmlFor="first-name"
            >
              First Name
            </label>
          ...
          <div className="w-full h-12 relative flex rounded-xl mb-6">
            <input
              required
              className="peer w-full  outline-none px-4 text-base rounded-xl bg-white  border-2 hover:border-n-8 shadow-md focus:shadow-md focus:shadow-n-8 "
              id="confirm-password"
          ...
          {/* Submit Button */}
          <button  type='button' className="my-5 border-2 relative overflow-hidden bg-gradient-to-r from-green-400 to-n-6 text-white py-2.5 px-6 font-semibold 
        rounded-3xl shadow-xl transform transition-all duration-500 hover:scale-110  ">
        <span className="relative z-10">Sign Up</span>
      </button>        
          <p class="text-gray-900 mb-4 text-center"> Already have an account? <a class="text-sm text-blue-500 -200 hover:underline mt-4" href="/Signin">Sign In</a></p>
          <p class="text-gray-900 text-center mb-4"> Or </p>
        ...
        <div>
          <button className="flex mb-2 items-center justify-center py-2 px-20 bg-white hover:  text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg hover:scale-105">
            <svg
              viewBox="0 0 24 24"
              height="25"
              width="25"
          ...
          <button class="flex items-center justify-center py-2 px-20 bg-white hover:  text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg hover:scale-105">
