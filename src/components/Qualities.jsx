...
const Qualities = () => {
  return (
    <div className='py-8 bg-n-6'>
      <div className='text-center'>
        <h1 className='h2 font-bold text-n-7'>Why Choose Us</h1>
        <p className='my-4 body-1 max-w-xl mx-auto font-bold text-n-7/90'>
      ...
      <div className='flex mx-auto w-[89%] flex-row gap-9 my-14 '>
        <div className='flex-1 bg-n-8 p-4 text-n-6 rounded-xl hover:shadow-xl hover:shadow-n-8 border-2'>
